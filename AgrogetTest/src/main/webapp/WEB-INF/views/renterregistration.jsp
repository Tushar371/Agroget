        ...
        <div class="col-lg-9 align-self-center">
          <div class="row">
            <div class="col-lg-12 setborder">
              <form id="contact" action="addRenter1" method="post" enctype="multipart/form-data" >
                <div class="row">
                  <div class="col-lg-12 ">
                  ...
                  <div class="col-lg-4">
                    <fieldset>
                      <input name="shopdetails" type="text" id="shopdetails" placeholder="shopdetails" required="">
                    </fieldset>
                  </div>
                  ...
                  <div class="col-lg-5">
                   <!--  <fieldset class="height"><label for="files" class="btn">Upload Kisan Card</label>
                    ...
                    <fieldset class="height"><label">Upload Identity Card </label>
                  ...
                  <div>
                    <hr>
                 <h6 style="margin-left: 340px;">Already User? <a href="Login.html"><u style="color: green;">Login here</u></a></h6>
                  </div>
